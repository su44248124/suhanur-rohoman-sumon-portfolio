      ...
      <div className="hero min-h-screen   ">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <div className="relative ">
            <Wave
              className="image-background mb-6"
              fill="#3F51B5"
              paused={false}
              options={{
                height: 5,
            ...
            <img
              ...
              src={img}
              className="w-full h-[300px] rounded-lg p-4  shadow-2xl absolute top-0 left-0 right-0 bottom-0 m-auto"
            />
          ...
          <div data-aos="fade-up" data-aos-duration="3000">
            <h1 className="md:text-5xl text-4xl font-bold mt-6 text-indigo-600">
              Hey I am Suhanur Rohoman Sumon
            </h1>
