    ...
    <div className="relative">
      ...
      <Element className="" name="skills">
        ...
        <div
          ...
          className="flex  border border-[#D0ABFF]  p-8 items-center justify-center md:w-9/12 md:mx-auto  "
        >
          <div className="w-full ">
            <div className="md:flex flex-wrap grid grid-cols-2 gap-2">
              ...
              <div className="border font-bold border-[#D0ABFF] text-[#D0ABFF] text-center  uppercase text-2xl rounded-md p-4 flex-1 mx-2 min-w-[150px]">
                CSS
              </div>
              <div className="border text-2xl font-bold border-[#D0ABFF] text-[#D0ABFF] text-center  uppercase rounded-md p-4 flex-1 mx-2 min-w-[150px]">
                Tailwind
              </div>
              <div className="border font-bold border-[#D0ABFF] text-[#D0ABFF] text-center  uppercase text-2xl rounded-md p-4 flex-1 mx-2 min-w-[150px]">
                Bootstrap
